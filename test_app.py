...
from models import (
    ...
    Actor, Movie, Performance, db_drop_and_create_all)
...
casting_assistant_auth_header = {
    'Authorization': os.environ['casting_assistant']
}

casting_director_auth_header = {
    'Authorization': os.environ['casting_director']
}

executive_producer_auth_header = {
    'Authorization': os.environ['executive_producer']
}
...
# Test driven development (TDD): Create testcases first,
# then add endpoints to pass tests
...
#   ----------------------------------------------------------------------------#
    ...
    def test_error_422_create_new_actor(self):
        ...
        self.assertEqual(data['message'],
                         'No name provided, name is required.')
...
#   ----------------------------------------------------------------------------#
    ...
    def test_error_404_get_actors(self):
        ...
        res = self.client().get('/actors?page=123456789',
                                headers=casting_assistant_auth_header)
        data = json.loads(res.data)
...
#   ----------------------------------------------------------------------------#
    ...
    def test_error_400_edit_actor(self):
        ...
        res = self.client().patch('/actors/123456',
                                  headers=casting_director_auth_header)
        data = json.loads(res.data)
    ...
    def test_error_404_edit_actor(self):
        ...
        res = self.client().patch('/actors/12345',
                                  json=json_edit_actor_with_new_age,
                                  headers=casting_director_auth_header)
        data = json.loads(res.data)
        ...
        self.assertFalse(data['success'])
        self.assertEqual(data['message'],
                         'Actor with id 12345 does not exist.')
...
#   ----------------------------------------------------------------------------#
    ...
    def test_error_404_delete_actor(self):
        ...
        res = self.client().delete('/actors/12345',
                                   headers=casting_director_auth_header)
        data = json.loads(res.data)
...
#   ----------------------------------------------------------------------------#
    ...
    def test_error_422_create_new_movie(self):
        ...
        self.assertFalse(data['success'])
        self.assertEqual(data['message'],
                         'No title provided, the title is required.')
...
#   ----------------------------------------------------------------------------#
    ...
    def test_error_404_get_movies(self):
        ...
        res = self.client().get('/movies?page=123456',
                                headers=casting_assistant_auth_header)
        data = json.loads(res.data)
...
# ----------------------------------------------------------------------------#
    ...
    def test_error_404_edit_movie(self):
        ...
        res = self.client().patch('/movies/12345', json=json_edit_movie,
                                  headers=executive_producer_auth_header)
        data = json.loads(res.data)
        ...
        self.assertFalse(data['success'])
        self.assertEqual(data['message'],
                         'Movie with id 12345 does not exist.')
...
# ----------------------------------------------------------------------------#
    ...
    def test_error_404_delete_movie(self):
        ...
        res = self.client().delete('/movies/123456',
                                   headers=executive_producer_auth_header)
        data = json.loads(res.data)
        ...
        self.assertFalse(data['success'])
        self.assertEqual(data['message'],
                         'Movie with id 123456 does not exist.')
